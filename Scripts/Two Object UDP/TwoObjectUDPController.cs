...
public class TwoObjectUDPController : MonoBehaviour
{
	...
	private TwoObjectTimingController timingBar;
    ...
    void Start()
    {
		...
		timingBar = GameObject.Find("Timing Bar").gameObject.GetComponent<TwoObjectTimingController>();
