...
public class UDPFourController : MonoBehaviour
{
	...
	private GridNavigationFourController grid;
	...
	{
		init ();
		grid = GameObject.Find("8x8 Grid Step").gameObject.GetComponent<GridNavigationFourController>();
	...
	private  void ReceiveData ()
	{
		while (true) {
			try {
				...
				lastReceivedUDPPacket = message.ToString ();
